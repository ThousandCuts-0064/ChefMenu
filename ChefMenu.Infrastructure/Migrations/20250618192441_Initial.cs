    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:measurement_unit", "count,grams,liters")
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_products_users_updated_by_id",
                        column: x => x.updated_by_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_product_recipe", x => new { x.product_id, x.recipe_id });
                    table.ForeignKey(
                        name: "fk_product_recipe_products_product_id",
                        column: x => x.product_id,
                        principalTable: "products",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_product_recipe_recipes_recipe_id",
                        column: x => x.recipe_id,
                        principalTable: "recipes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_product_recipe_users_created_by_id",
                        column: x => x.created_by_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_user_actions", x => new { x.created_by_id, x.type, x.chef_id, x.product_id, x.kitchenware_id, x.category_id, x.keyword_id, x.recipe_id, x.recipe_collection_id, x.comment_id });
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_user_actions_products_product_id",
                        column: x => x.product_id,
                        principalTable: "products",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_product_recipe_created_by_id",
                table: "product_recipe",
                column: "created_by_id");

            migrationBuilder.CreateIndex(
                name: "ix_product_recipe_recipe_id",
                table: "product_recipe",
                column: "recipe_id")
                .Annotation("Npgsql:IndexInclude", new[] { "product_id" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_products_updated_by_id",
                table: "products",
                column: "updated_by_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_actions_product_id",
                table: "user_actions",
                column: "product_id",
